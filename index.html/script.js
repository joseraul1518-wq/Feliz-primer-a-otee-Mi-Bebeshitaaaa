 ...
 const photos = [
  ...
  { url: 'IMG30.jpg', text: 'La primera fotito que me enviooo. 😭🤎' }
    ...
    photos.forEach((photo, index) => {
        ...
        // Asignar la imagen directamente como fondo del nodo
        star.style.backgroundImage = `url(${photo.url})`;

        // Etiqueta numerada para identificar cada estrella
    ...
    // Asignación de IMG1.jpg para el puzle
